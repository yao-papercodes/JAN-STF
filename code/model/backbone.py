...
class ResNet50Fc(nn.Module):
    def __init__(self, in_channels, num_classes, patch_size, init_weights=True):
        ...
        model_resnet50 = models.resnet50(weights=True)
        # self.conv1 = model_resnet50.conv1
        self.conv1 = nn.Conv2d(in_channels, 64, stride=2, kernel_size=7, padding=3, bias=False)
        ...
        fc_in_features_dim = model_resnet50.fc.in_features
        self.fc = nn.Linear(fc_in_features_dim, num_classes)
